	...
	*/
	...
	function getTableList($skip_authentication = false){
		...
		$arrTables = array(
			...
			'Possible_Attacks' => array('Possible Attacks', '', 'resources/table_icons/bug.png', 'None')
		);
	...
	function get_sql_fields($table_name){
		$sql_fields = array(   
			'Possible_Attacks' => "`Possible_Attacks`.`id` as 'id', `Possible_Attacks`.`title` as 'title', `Possible_Attacks`.`description` as 'description'"
		);
	...
	function htmlUserBar(){
		...
		<nav class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo PREPEND_PATH; ?>index.php"><i class="glyphicon glyphicon-home"></i> SQLIPS</a>
			</div>
